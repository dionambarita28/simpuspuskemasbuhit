                            ...
                            <form method="post" action="<?= base_url('pasien/addProses'); ?>" class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control inp" type="text" value="" id="nama" name="no_pasien">
                                    </div>
                                    <div class="form-group">
                                        <label for="supplier" class="col-form-label">No Ktp</label>
                                        <input class="form-control inp" type="text" value="" id="nama" name="no_ktp">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control inp" type="text" value="" id="nama" name="pekerjaan">
                                    </div>
                                    <div class="form-group">
                                        <label for="supplier" class="col-form-label">Alamat</label>
                                        <textarea class="form-control inp" id="keterangan" name="alamat"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control inp" type="text" value="" id="tinggi" name="tinggi">
                                    </div>
                                    <div class="form-group">
                                        <label for="supplier" class="col-form-label">Berat Badan(kg)</label>
                                        <input class="form-control inp" type="text" value="" id="berat" name="berat">
                                    </div>
                                    <div class="form-group">
                                        <label for="supplier" class="col-form-label">Jenis Pasien</label>
                                        <input class="form-control inp" type="text" value="" id="jenis" name="jenis_pasien">
                                    </div>
